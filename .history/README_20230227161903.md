...
Bracket Expressions.
 ...
 A bracket expression represents a character set  a list of characters enclosed by the square brackets: '[' and ']'. It normally matches the target string with any single character from the list.
