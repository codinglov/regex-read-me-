...
Bracket Expressions.
 ...
 A bracket expression represents a character set th a list of characters enclosed by the square brackets: '[' and ']'. It normally matches the target string with any single character from the list.
...
The backslash character, \, keeps the same meaning in a bracket expressions, allowing use of the special escape sequences: such as \n, \t, \w, \d, etc.
