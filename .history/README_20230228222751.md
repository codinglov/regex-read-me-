...
Examples include:
            ...
            -\d matches any arabic numeral digit. It is equivalent to the bracket expression [0-].
            -\w Matches any alphanumeric character from the basic Latin alphabet, including(_)
