...
the OR character ,|, relays the message or for example [abc] cand also be written as [a|b|c] if the OR  character was used.
### Flags
...
Laura Makokha
 https://github.com/codinglov/regex-read-me-.git